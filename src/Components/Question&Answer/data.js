export const data = [ 
  {
    ...
    subTitle: `Netflix is a streaming service that offers a wide variety of
...

  {
    ...
    subTitle: `Watch Netflix on your smartphone, tablet, Smart TV, 
      laptop, or streaming device, all for one fixed monthly fee.Plans 
      range from ₹ 149 to ₹ 649 a month.No extra costs, no contracts.`,
  },

  {
    title: "Where can i watch?",
    subTitle: `Watch anywhere, anytime. Sign in with your Netflix account 
...
`,
...

  {
    ...
    subTitle: `Netflix is flexible. There are no annoying contracts and no commitments. 
...
`,
...

  {
    ...
    subTitle: `Netflix has an extensive library of feature films, documentaries, TV shows,
     anime, award-winning Netflix originals, and more. Watch as much as you want, anytime 
     you want.
`,
  },
  {
    title: "Is Netflix good fo kids?",
    subTitle: `The Netflix Kids experience is included in your membership to give parents control 
    while kids enjoy family-friendly TV shows and films in their own space. Kids profiles come with
